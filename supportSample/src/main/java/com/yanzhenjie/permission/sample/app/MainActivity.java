...
import com.yanzhenjie.permission.rationale.NotifyListenerRationale;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_test_notify).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_test_notify: {
                Intent intent = new Intent(MainActivity.this, EnableNotificationAccessActivity.class);
