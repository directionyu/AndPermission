...
public class SystemUtils {
     ...
     * 获取WindowManager。
     */
    private static WindowManager getWindowManager(Context mContext) {
        if (mContext == null) {
            return null;
        }
     ...
     * @return
     */
    private static int dip2px(Context mContext, float dipValue) {
    ...
    private static int getStatusBarHeightByReflect(Context mContext) {
        //int sbHeight;
